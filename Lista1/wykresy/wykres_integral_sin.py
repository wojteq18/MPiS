...
#wczytywanie danych
data = pd.read_csv("/home/vostok/codes/MPiS/Lista1/integral_sin/integral_sin.txt", sep=",", names=["attempt", "points", "estimate"], skiprows = 1)
...
#dodanie linii poziomej dla rzeczywistej wartosci calki = 2
plt.axhline(y=2, color='orange', linestyle='--', linewidth=1.5, label="y = 2")

# Dodanie etykiet i tytułu
plt.xlabel("Liczba punktów")
plt.ylabel("Oszacowanie calki")
plt.title("Wykres oszacowania calki $\\int_0^π sin(x) dx$ dla k = 50")
plt.legend()
plt.grid(True)
plt.show()
