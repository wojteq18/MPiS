...
#wczytywanie danych
data = pd.read_csv("/home/vostok/codes/MPiS/Lista1/integral_3rdroot/integral_3rdroot.txt", sep=",", names=["attempt", "points", "estimate"], skiprows = 1)
...
plt.axhline(y=12, color='orange', linestyle='--', linewidth=1.5, label="y = 12")

# Dodanie etykiet i tytułu
plt.xlabel("Liczba punktów")
plt.ylabel("Oszacowanie calki")
plt.title("Wykres oszacowanie calki $\\int_0^8 \\sqrt[3]{x} dx$ dla k = 50")
plt.legend()
plt.grid(True)
plt.show()
